...
class BudApp:
    ...
    # Remove Category Limit - Removes the chosen category limit
    ...
    def Gen_Tra(self):
        ...
        for c, s, d, t in zip(self.tra_category, self.tra_spent, self.tra_desc, self.tra_date): #pairs category, spent, and description together
